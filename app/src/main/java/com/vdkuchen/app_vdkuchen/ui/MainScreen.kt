...
fun MainScreenContent(services: List<JSONObject>, navController: NavController, viewModel: UserViewModel) {
    LazyColumn {
        ...
        items(services) { service ->
            ...
            val serviceId = service.getInt("id")
            ...
            Row(
                ...
                Icon(
                    ...
                    contentDescription = "Estado pendiente",
            ...
            Row (
                modifier = Modifier.clickable {
                    ...
                    viewModel.selectedServiceId.value = serviceId
...
fun MainScreenPreview() {
    val viewModel = UserViewModel() // Aquí puedes inicializar viewModel según sea necesario
